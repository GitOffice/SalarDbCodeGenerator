namespace SalarDbCodeGenerator.Presentation
{
	partial class frmAbout
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnClose.Location = new System.Drawing.Point(377, 250);
			...
			this.groupBox1.Size = new System.Drawing.Size(301, 232);
			...
			this.lnkUpdate.Text = "http://salardbcodegenerator.codeplex.com/";
			...
			this.label6.Text = "This application is aimed to generate .NET class and methods for databases and mo" +
    "del them based on customizable patterns.";
			// 
			// lblLicense
			// 
			this.lblLicense.AutoSize = true;
			this.lblLicense.Location = new System.Drawing.Point(75, 167);
			this.lblLicense.Name = "lblLicense";
			this.lblLicense.Size = new System.Drawing.Size(157, 13);
			this.lblLicense.TabIndex = 6;
			this.lblLicense.Text = "Free and Open-Source (GPLv2)";
			// 
			// label5
			// 
			...
			this.label3.Text = "Copyright © 2009-2012 All Rights Reserved";
			// 
			// label9
			// 
			...
			this.label1.Text = "Salar Db CodeGenerator";
			// 
			// frmAbout
			// 
